...
public class Alerta {
    ...
    public Alerta(Context pContexto, String pTitulo, String pTexto) {
        mTitulo = pTitulo;
        mTexto = pTexto;
        mContexto = pContexto;
    ...
    public void show() {
        validarSePodeAbrir(context -> {
            ...
            dialog.setTitle(mTitulo);
            dialog.setIcon(R.mipmap.ic_icone_new);
            dialog.setMessage(mTexto);
    ...
    public void showPendencias(DialogInterface.OnClickListener pDialogSim, DialogInterface.OnClickListener pDialogNao) {
        showConfirmNeutral(pDialogSim, "Resolver agora", pDialogNao, "OK");
    }
