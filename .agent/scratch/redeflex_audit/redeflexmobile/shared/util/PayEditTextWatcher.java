...
public class PayEditTextWatcher implements TextWatcher {
    ...
    private IPayEditTextWatcherCallback callback;

    public PayEditTextWatcher(EditText editText, String formatType) {
        this.editText = editText;
        this.formatType = formatType;
        Log.e(T, "::PayTextWatcher:" + "formatType " + formatType);
    }

    public void setCallback(IPayEditTextWatcherCallback callback) {
    ...
    public synchronized void afterTextChanged(Editable s) {
        ...
        if (!s.toString().equals(current)) {
            ...
            if (callback != null) callback.onAfterTextChange(s.toString());
        }
    ...
    public interface IPayEditTextWatcherCallback {
        void onAfterTextChange(String texto);
    }
}