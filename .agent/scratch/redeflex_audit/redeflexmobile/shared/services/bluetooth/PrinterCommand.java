...
public class PrinterCommand {
    public static byte[] POS_Set_PrtInit() {
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_Init});
        return data;
    }

    public static byte[] POS_Set_LF() {
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.LF});
    ...
    public static byte[] POS_Set_PrtAndFeedPaper(int feed) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_J});
        return data;
    }

    public static byte[] POS_Set_PrtSelfTest() {
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.US_vt_eot});
        return data;
    }
    ...
    public static byte[] POS_Set_Beep(int m, int t) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_B_m_n});
        return data;
    }
    ...
    public static byte[] POS_Set_Cut(int cut) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_V_m_n});
        return data;
    }
    ...
    public static byte[] POS_Set_Cashbox(int nMode, int nTime1, int nTime2) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_p});
        return data;
    }
    ...
    public static byte[] POS_Set_Absolute(int absolute) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_Relative});
        return data;
    }
    ...
    public static byte[] POS_Set_Relative(int relative) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_Absolute});
        return data;
    }
    ...
    public static byte[] POS_Set_LeftSP(int left) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_LeftSp
        });
        return data;
    }
    ...
    public static byte[] POS_Set_PrintWidth(int width) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_W
        });
        return data;
    }
    ...
    public static byte[] POS_Set_LineSpace(int space) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_Three
        });
        return data;
    }
    ...
    public static byte[] POS_Set_CodePage(int page) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_t});
    ...
    public static byte[] POS_Print_Text(String pszString, String encoding, int codepage,
        ...
        if (codepage == 0) {
            byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_ExclamationMark, Command.ESC_t, Command.FS_and, Command.ESC_M, pbString});
            return data;
        } else {
            byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_ExclamationMark, Command.ESC_t, Command.FS_dot, Command.ESC_M, pbString});
            return data;
        }
    }
    ...
    public static byte[] POS_Set_Bold(int bold) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_E, Command.ESC_G});
        return data;
    }

    public static byte[] POS_Set_LeftBrace(int brace) {
        Command.ESC_LeftBrace[2] = (byte) brace;
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_LeftBrace});
        return data;
    }
    ...
    public static byte[] POS_Set_UnderLine(int line) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_Minus, Command.FS_Minus});
        return data;
    }
    ...
    public static byte[] POS_Set_FontSize(int size1, int size2) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{
    ...
    public static byte[] POS_Set_Inverse(int inverse) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.GS_B});
        return data;
    }
    ...
    public static byte[] POS_Set_Rotate(int rotate) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_V});
        return data;
    }
    ...
    public static byte[] POS_Set_ChoseFont(int font) {
        ...
        byte[] data = UtilPrint.byteArraysToBytes(new byte[][]{Command.ESC_M});
        return data;
