...
public class RelatorioSupervisorVendasTask
        extends AsyncTask<RelatorioSupervisorVendedor, Void, RequestModelGeneric<RelatorioSupervisorProduto>> {

    private OnTaskAction onTaskAction;
    private Vendedor vendedor;
    private int position;

    public RelatorioSupervisorVendasTask(OnTaskAction onTaskAction) {
    ...
    protected RequestModelGeneric<RelatorioSupervisorProduto> doInBackground(RelatorioSupervisorVendedor... relatorio) {
        ...
        RequestModel dados = RelatorioSupervisorBus.obterVendasVendedor(relatorio[0]);
    ...
    public RelatorioSupervisorVendasTask setVendedor(Vendedor vendedor) {
        this.vendedor = vendedor;

        return this;
    }

    public RelatorioSupervisorVendasTask setPosition(int position) {
    ...
    public interface OnTaskAction {
        void taskAction(RequestModelGeneric<RelatorioSupervisorProduto> produtos,
                        Vendedor vendedor, int position);
    }
}
