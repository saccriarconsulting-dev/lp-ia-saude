...
public class MerchandisingFachada {
    private int id;
    ...
    public MerchandisingFachada() {
    }

    public MerchandisingFachada(int idMerchandising, String merchanInterno, String merchanExterno, String caminhoFotoInterno, String caminhoFotoExterno) {
    ...
    public void setMerchanInterno(boolean interno) {
        this.merchanInterno = interno ? "S" : "N";
    }
    ...
    public void setMerchanExterno(boolean externo) {
        this.merchanExterno = externo ? "S" : "N";
    }
