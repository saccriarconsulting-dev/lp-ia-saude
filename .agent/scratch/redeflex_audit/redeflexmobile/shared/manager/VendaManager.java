...
public interface VendaManager {
    ...
    boolean temSaldo(String produtoId, int quantidade, int quantidadeAtual);
    ...
    boolean produtoCombo(String produtoId);

    int retornaQtdPrecoDiferenciado(String idPreco);

    boolean isProdutoCombo(String codigoProd);

    Single<List<EstruturaProd>> getItemsCombo(String id);
}
