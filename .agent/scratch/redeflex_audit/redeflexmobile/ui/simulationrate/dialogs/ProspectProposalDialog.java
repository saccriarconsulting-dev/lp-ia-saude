 ...
 */
public class ProspectProposalDialog extends BaseDialog {
    ...
    public static ProspectProposalDialog newInstance(CancelRegisterRateDialogListener confirmCallback) {
        ProspectProposalDialog dialog = new ProspectProposalDialog();
    ...
    protected int getContentView() {
        return R.layout.dialog_prospect_proposal;
    }
